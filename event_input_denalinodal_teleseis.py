...
# python run_getwaveform.py event_input_denalinodal 0
    ...
    #second run set ev_info.ifph5 = False (or just comment it out) and request permanent stations
        ...
        ev_info.resample_freq = 50 #this is the default and must be 50 for both nodes and permanent stations for cap!
        ev_info.scale_factor = 100 
        ...
        #ev_info.phase_window = True #this cuts the seismogram
        #ev_info.phases = ["P","S"] # Choosing time period with respect to P & S
        #ev_info.write_sac_phase = True #note: cap can reads in taup picks from sac header
        
        #Set the water level high (6000) to have the nodal data waveforms match that of the permanent stations at long periods (10-20s)
        ev_info.water_level = 6000  
        #ev_info.water_level = 60 #default is 60
