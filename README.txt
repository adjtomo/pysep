...
+ cd pysep
+ conda env create -f ./setup/pysep.yml
...
+ debugging plots: spectrograms, instrument response

Additional features
+ remove waveforms that are clipped by the digitizer (assumes N-bit for digitizer)
